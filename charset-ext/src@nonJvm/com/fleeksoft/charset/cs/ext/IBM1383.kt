...
class IBM1383 : Charset("x-IBM1383", null) {

    override fun contains(cs: Charset): Boolean {
        return ((cs.name() == "US-ASCII") || (cs is IBM1383))
    }

    override fun newDecoder(): CharsetDecoder {
        return DoubleByte.Decoder_EUC_SIM(this, DecodeHolder.b2c, DecodeHolder.b2cSB, 0xa1, 0xfe, true)
    }

    override fun newEncoder(): CharsetEncoder {
        return DoubleByte.Encoder_EUC_SIM(this, EncodeHolder.c2b, EncodeHolder.c2bIndex, true)
    }
    ...
    object EncodeHolder {
        val c2b: CharArray = CharArray(0x6900)
