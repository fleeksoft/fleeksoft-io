...
class Big5 : Charset("Big5", null) {
    ...
    override fun newDecoder(): CharsetDecoder {
        return DoubleByte.Decoder(this, DecodeHolder.b2c, DecodeHolder.b2cSB, 0x40, 0xfe, true)
    }

    override fun newEncoder(): CharsetEncoder {
        return DoubleByte.Encoder(this, EncodeHolder.c2b, EncodeHolder.c2bIndex, true)
    }
    ...
    object EncodeHolder {
        val c2b: CharArray = CharArray(0x6400)
        val c2bIndex: CharArray = CharArray(0x100)

        init {
            val b2cNR = "\uA15A\uFF3F\uA1FE\u2571\uA240\u2572\uA2CC\u5341" + "\uA2CE\u5345"

            val c2bNR: String? = null
            DoubleByte.Encoder.initC2B(DecodeHolder.b2cStr, DecodeHolder.b2cSBStr, b2cNR, c2bNR, 0x40, 0xfe, c2b, c2bIndex)
        }
    }
}
