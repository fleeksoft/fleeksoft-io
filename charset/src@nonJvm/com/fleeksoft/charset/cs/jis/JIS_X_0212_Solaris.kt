...
class JIS_X_0212_Solaris : Charset("x-JIS0212_Solaris", null) {
    companion object {
        val INSTANCE = JIS_X_0212_Solaris()
    }

    override fun contains(cs: Charset): Boolean {
        return (cs is JIS_X_0212_Solaris)
    }
    ...
    object EncodeHolder {
        val c2b: CharArray = CharArray(0x5d00)
