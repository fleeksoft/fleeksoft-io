...
class JIS_X_0208_Solaris : Charset("x-JIS0208_Solaris", null) {
    ...
    override fun newDecoder(): CharsetDecoder {
        return DoubleByte.Decoder_DBCSONLY(this, DecodeHolder.b2c, DecodeHolder.b2cSB, 0x21, 0x7e, false)
    }

    override fun newEncoder(): CharsetEncoder {
        return DoubleByte.Encoder_DBCSONLY(this, byteArrayOf(0x21.toByte(), 0x29.toByte()), EncodeHolder.c2b, EncodeHolder.c2bIndex, false)
    }
    ...
    object EncodeHolder {
        val c2b: CharArray = CharArray(0x5200)
