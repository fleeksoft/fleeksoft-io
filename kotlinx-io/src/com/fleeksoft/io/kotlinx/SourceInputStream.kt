...
internal class SourceInputStream(private val source: Source) : InputStream() {
    private var sourceMark: Source? = null

    private fun source(): Source = sourceMark ?: source
    ...
    override fun read(bytes: ByteArray, off: Int, len: Int): Int {
        return source().readAtMostTo(bytes, off, off + len)
    }
