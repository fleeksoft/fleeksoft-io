...
class IBM1364 : Charset("x-IBM1364", null) {
    

    override fun contains(cs: Charset): Boolean {
        return (cs is IBM1364)
    }

    override fun newDecoder(): CharsetDecoder {
        return DoubleByte.Decoder_EBCDIC(
            this,
            DecodeHolder.b2c,
            DecodeHolder.b2cSB,
            0x40,
    ...
    override fun newEncoder(): CharsetEncoder {
        return DoubleByte.Encoder_EBCDIC(
            this,
            EncodeHolder.c2b,
    ...
    object EncodeHolder {
        val c2b: CharArray = CharArray(0x9c00)
